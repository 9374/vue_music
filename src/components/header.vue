...
import { loginRefresh, loginInPhone, loginInEmail, loginStatus, userSigninAPI, userLoginOut, loginCreateKey, loginInitQr, confirmQrStatus } from '@/api/userAPI.js'
...
export default {
  ...
  methods: {
    ...mapMutations('user', ['initUserCookie', 'initUserInfo', 'clearUserInfo']),
